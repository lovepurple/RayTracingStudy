...
HitableList* getHitableWorld() {
	//加入扰动
	Sphere* sphere1 = new Sphere(Screen::normalizedUVtoReal(vec3(0.75f, 0.5f, -1)), 0.125f, new MetalMaterial(vec3(0.8, 0.6, 0.2), 0.3));
	Sphere* sphere2 = new Sphere(Screen::normalizedUVtoReal(vec3(0.25f, 0.5f, -1)), 0.125f, new MetalMaterial(vec3(0.8, 0.8, 0.8), 1.0));
